...
// копируем фаилы css
function appcss(){
	return gulp.src([path.src.appcss, path.src.bcss])
	.pipe(plumber())
...
gulp.task('build', gulp.series('clean', 
	// gulp.parallel('appcss', 'css', 'js', 'jq','appjs', 'fonts', 'img', 'html' ))
	gulp.parallel('appcss', 'css', 'js','appjs', 'fonts', 'img', 'html' ))
);
